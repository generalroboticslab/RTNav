...
class OVONSimulatorConfig(SimulatorConfig):
    type: str = "OVONSim-v0"
    navmesh_settings: NavmeshSettings = field(default_factory=NavmeshSettings)


@dataclass
class OVONHabitatConfig(HabitatConfig):
    simulator: SimulatorConfig = field(default_factory=OVONSimulatorConfig)
...
class OVONPolicyConfig(PolicyConfig):
    ...
    finetune: PolicyFinetuneConfig = field(default_factory=PolicyFinetuneConfig)
...
class OVONRLConfig(RLConfig):
    policy: OVONPolicyConfig = field(default_factory=OVONPolicyConfig)


@dataclass
class OVONBaselinesRLConfig(HabitatBaselinesRLConfig):
    rl: OVONRLConfig = field(default_factory=OVONRLConfig)
