...
class MappingConfig:
    ...
    # Drop obstacle connected components smaller than this many pixels (speckles).
    min_obstacle_area_px: int = 3
    occupancy_trav_threshold: float = 0.1  # traversability below this = occupied
