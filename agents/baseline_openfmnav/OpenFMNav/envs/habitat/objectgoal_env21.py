...
from constants import object_category
...
class ObjectGoal_Env21(habitat.RLEnv):
    ...
    def reset(self):
        ...
        self.info['goal_cat_id'] = obs['objectgoal'][0] # 0-5
        self.info['goal_name'] = object_category[obs['objectgoal'][0]]

        self.goal_name = object_category[obs['objectgoal'][0]]
    ...
    def step(self, action):
        ...
        if done:
            ...
            spl, success, dist = metrics['spl'], metrics['success'], metrics['dist']
    ...
    def get_fmm_distance(self, target_point_map, frontier_loc_g):
